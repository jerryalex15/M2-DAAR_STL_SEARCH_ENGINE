...
\section{Partie test : obtention des testbeds}
    ...
    \begin{itemize}
        ...
        \item \textit{Nettoyage : }Le texte brut a été nettoyé en supprimant les caractères spéciaux, en convertissant tous les mots en minuscules et en éliminant les mots de moins de 3 caractères. Les mots ainsi retenus sont stockés dans une liste. Dans le calcul de la similarité de Jaccard, ces mots sont placés dans un ensemble (\textit{set}) de Python.
