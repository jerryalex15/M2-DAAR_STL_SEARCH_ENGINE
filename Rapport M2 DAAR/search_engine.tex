...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \huge\textbf{\textcolor{blue}{CHOIX A}} \\[1cm]
        ...
        \Large\textbf{Responsable:} Binh-Minh BUI-XUAN\\[1.5cm]
...
\section{Présentation théorique des algorithmes}
    ...
    \begin{algorithm}[H]
        ...
        Où $a$ est un vecteur contenant le score de PageRank pour chaque sommet (document), $M$ est une matrice stochastique d'adjacence d'un graphe, et $\epsilon$ est une valeur très proche de 0. Dans le domaine du WEB, on peut fixe à $300$fois le nombre d'itération dans la boucle (Résultat expérimental).
